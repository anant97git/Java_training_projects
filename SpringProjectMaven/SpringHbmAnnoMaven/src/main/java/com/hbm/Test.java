...
//		Employee e = new Employee(104, "Ishu5", 3500); dao.saveEmployee(e);
		
		//Employee e = new Employee(102, "Ishu4", 550000); dao.updateEmployee(e);
//		Employee e = new Employee(104, "Ishu4", 550000); dao.updateEmployee(e);
		
		//Employee e=new Employee(); e.setId(103); dao.deleteEmployee(e);
		Employee e=new Employee(); e.setId(104); dao.deleteEmployee(e);
