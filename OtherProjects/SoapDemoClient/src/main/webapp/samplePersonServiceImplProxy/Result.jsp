...
<jsp:useBean id="samplePersonServiceImplProxyid" scope="session" class="com.jaxrs.service.PersonServiceImplProxy" />
<%
...
case 10:
        gotMethod = true;
        com.jaxrs.service.PersonServiceImpl getPersonServiceImpl10mtemp = samplePersonServiceImplProxyid.getPersonServiceImpl();
...
case 15:
        ...
        %>
        <jsp:useBean id="com1jaxws1beans1Person_1id" scope="session" class="com.jaxws.beans.Person" />
        <%
        com1jaxws1beans1Person_1id.setAge(age_2idTemp);
        com1jaxws1beans1Person_1id.setName(name_3idTemp);
        com1jaxws1beans1Person_1id.setId(id_4idTemp);
        boolean addPerson15mtemp = samplePersonServiceImplProxyid.addPerson(com1jaxws1beans1Person_1id);
...
case 31:
        ...
        com.jaxws.beans.Person getPerson31mtemp = samplePersonServiceImplProxyid.getPerson(id_6idTemp);
...
case 42:
        gotMethod = true;
        com.jaxws.beans.Person[] getAllPersons42mtemp = samplePersonServiceImplProxyid.getAllPersons();
...
<%
        ...
        // tempreturnp43 = listreturnp43.toString();
        	...
        	java.util.List<com.jaxws.beans.Person> listreturnp43= java.util.Arrays.asList(getAllPersons42mtemp);
            //tempreturnp43 = listreturnp43.toString();
